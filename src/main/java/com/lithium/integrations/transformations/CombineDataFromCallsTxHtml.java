...
public class CombineDataFromCallsTxHtml extends AbstractMessageTransformer {
	...
	public static String wrapHtmlBody(AuthorAvatarCombined authorAvatarCombineddy) {
		...
		output += ONE_PRE + "average_message_rating" + TWO_PRE + authorAvatarCombineddy.getAverage_message_rating()
				+ THREE_POST;
		...
		output += ONE_PRE + "accept_private_notes_consent_agreement" + TWO_PRE
				+ authorAvatarCombineddy.getAccept_private_notes_consent_agreement() + THREE_POST;
		output += ONE_PRE + "autosave_interval" + TWO_PRE + authorAvatarCombineddy.getAutosave_interval() + THREE_POST;
		output += ONE_PRE + "badge_delivery_enable" + TWO_PRE + authorAvatarCombineddy.getBadge_delivery_enable()
				+ THREE_POST;
		output += ONE_PRE + "badge_email_delivery_freq" + TWO_PRE
				+ authorAvatarCombineddy.getBadge_email_delivery_freq() + THREE_POST;
		...
		output += ONE_PRE + "blogger_badge_orientation" + TWO_PRE
				+ authorAvatarCombineddy.getBlogger_badge_orientation() + THREE_POST;
		output += ONE_PRE + "blogger_badge_show_accepted_solutions" + TWO_PRE
				+ authorAvatarCombineddy.getBlogger_badge_show_accepted_solutions() + THREE_POST;
		output += ONE_PRE + "blogger_badge_show_avatar" + TWO_PRE
				+ authorAvatarCombineddy.getBlogger_badge_show_avatar() + THREE_POST;
		output += ONE_PRE + "blogger_badge_show_blogs" + TWO_PRE + authorAvatarCombineddy.getBlogger_badge_show_blogs()
				+ THREE_POST;
		output += ONE_PRE + "blogger_badge_show_ideas" + TWO_PRE + authorAvatarCombineddy.getBlogger_badge_show_ideas()
				+ THREE_POST;
		output += ONE_PRE + "blogger_badge_show_kudos" + TWO_PRE + authorAvatarCombineddy.getBlogger_badge_show_kudos()
				+ THREE_POST;
		output += ONE_PRE + "blogger_badge_show_post_count" + TWO_PRE
				+ authorAvatarCombineddy.getBlogger_badge_show_post_count() + THREE_POST;
		output += ONE_PRE + "blogger_badge_show_rank" + TWO_PRE + authorAvatarCombineddy.getBlogger_badge_show_rank()
				+ THREE_POST;
		output += ONE_PRE + "board_delivery_enable" + TWO_PRE + authorAvatarCombineddy.getBoard_delivery_enable()
				+ THREE_POST;
		output += ONE_PRE + "board_sub_email_delivery_freq" + TWO_PRE
				+ authorAvatarCombineddy.getBoard_sub_email_delivery_freq() + THREE_POST;
